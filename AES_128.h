...
typedef struct word
{
    unsigned char bytes[4]; // Array of 4 bytes (1 byte each)
} Word;

// s-box (globally defined)
...
// Inverse S-box (Globally defined)
...
extern unsigned char round_constants[];
extern unsigned char mix_columns_matrix[4][4];
extern unsigned char inv_mix_columns_matrix[4][4];
/////////////////////////////////////// Function Declarations ///////////////////////////

void RotWord(Word * );
Word * xorWords(const Word * , const Word * , Word * );
...
unsigned char ByteMultiply(unsigned char , unsigned char );
